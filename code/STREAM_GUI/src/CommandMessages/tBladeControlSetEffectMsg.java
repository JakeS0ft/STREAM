 ...
 * @author Jake
 */
public class tBladeControlSetEffectMsg extends CmdMsgBase
{
    public tBladeControlSetEffectMsg()
    {
        mMsgId = (byte)MessageIds.eeCmdBladeControlSetEffect.ordinal();
        mEffect = 0;
        mEnableNow = 0;
    }
