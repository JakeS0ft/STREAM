 ...
 * @author Jake
 */
public class tHumRepeatIntervalTestMsg extends CmdMsgBase
{
    public tHumRepeatIntervalTestMsg()
    {
        mMsgId = (byte)MessageIds.eeCmdHumRestartTest.ordinal();
    }
    ...
    public ArrayList<Byte> GetBytes()
    {
        ...
        lBytes.add(mMsgId);
        lBytes.addAll(Util.Converter.short2bytes(mInterval));
