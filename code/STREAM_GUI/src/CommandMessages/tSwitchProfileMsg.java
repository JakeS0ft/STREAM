 ...
 * @author Jake
 */
public class tSwitchProfileMsg extends CmdMsgBase {
    
    public tSwitchProfileMsg()
    {
        mMsgId = (byte)MessageIds.eeCmdSwitchProfile.ordinal();
    }
    ...
    {   
        ...
        lBytes.add(mMsgId); //1        
        lBytes.add(mProfileIdx); //2

        return lBytes;
    }
    
    public byte mProfileIdx;
}
