...
#ifndef PINS_DIYINO_H_
#define PINS_DIYINO_H_
...
//#define BUTTON2_PIN      7    //Input for Button 2
//#define BUTTON1_PIN  	 4   //Input for Button 1
#define BUTTON2_PIN      13    //Input for Button 2
#define BUTTON1_PIN  	 4   //Input for Button 1

#define ACCENT1          11   //Accent LED

#define PIXEL_DATA_PIN   12   //Pixel pin for NeoPixel blades
