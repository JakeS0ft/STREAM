...
#ifndef PINS_DIYINOSTARDUSTV3_H_
#define PINS_DIYINOSTARDUSTV3_H_

#include <Arduino.h>

/**
 * These pins are hard-wired by the Stardust V3 board.
 */
...
#define ACCENT1          A0   //Accent LED
#define PIXEL_DATA_PIN   13
#endif /* PINS_DIYINOSTARDUSTV3_H_ */
